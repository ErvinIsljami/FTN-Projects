...
// Check if socket is successfully created
	...
	do
	{
		...
		//postavljanje oba clienta u neblokirajuci rezim
		...
		do
		{
			...
			if (iResult != SOCKET_ERROR)
			{
				...
				sprintf_s(dataBuffer, "Poslali ste mi: %d bajtova.", strlen(dataBuffer));
			...
			if (iResult != SOCKET_ERROR)
			{
				...
				sprintf_s(dataBuffer2, "Poslali ste mi: %d bajtova.", strlen(dataBuffer2));
