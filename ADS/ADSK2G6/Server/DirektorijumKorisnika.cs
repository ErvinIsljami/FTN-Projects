...
namespace Server
{
    public class DirektorijumKorisnika
    {
        ...
        public DirektorijumKorisnika()
        {
            ...
            SortedSet<EPravaPristupa> replikacijaPrava = new SortedSet<EPravaPristupa>();
            replikacijaPrava.Add(EPravaPristupa.Replikacija);
            prava.Add("replikator", replikacijaPrava);
            prava.Add("replikator2", replikacijaPrava);
        }
