...
namespace Server
{
    public class DirektorijumKorisnika
    {
        ...
        public DirektorijumKorisnika()
        {
            ...
            DodajKorisnika("replikator1", "replikator1");
            DodajKorisnika("replikator2", "replikator2");
            ...
            prava.Add("replikator1", repliciranje);
            prava.Add("replikator2", repliciranje);
        }
        ...
        public string AutentifikacijaKorisnika(string ime, string lozinka)
        {
            ...
            {
                throw new FaultException<SecException>(new SecException("Neispravno korisnicko ime i / ili lozinka."));
        ...
        public bool KorisnikAutentifikovan(string token)
        {
            ...
            {
                throw new FaultException<SecException>(new SecException("Korisnik nije autentifikovan"));
            }
        }
        ...
        public bool KorisnikAutorizovan(string token, EPravaPristupa pravo)
        {
            ...
            && prava[autentifikovani[token]].Contains(pravo))
                ...
                throw new FaultException<SecException>(
                new SecException("Korisnik nema pravo: "+pravo.ToString()));
        }
    }
}
