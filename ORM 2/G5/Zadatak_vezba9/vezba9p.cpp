...
unsigned char* encrypt_data_vizner(const unsigned char* packet_data, unsigned char* app_data, int app_length);					// Returns a copy of packet with encrypted application data
unsigned char* encrypt_data_transpozicija(const unsigned char* packet_data, unsigned char* app_data, int app_length);					// Returns a copy of packet with encrypted application data
...
unsigned char* encrypt_data_vizner(const unsigned char* packet_data, unsigned char* app_data, int app_length)
{
	...
	memset(encrypted_data, 0, app_length);
...
[2][3] == 2 * 7 + 3
trenutniRed * ukupnoKolona + trenutnaKolona
